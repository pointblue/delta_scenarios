...
3) A flood risk scenario, in which sea level rise results in some islands in the central Delta having a projected annual risk of flooding >10% by 2085, making them primarily suitable for wetlands only. This scenario is based on projections developed for the [Delta Adapts](https://deltacouncil.ca.gov/delta-plan/climate-change) climate change vulnerability analyses and [supporting maps](https://deltascience.shinyapps.io/delta_flood_map/).
